...
<div>
  ...
  <div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <h1 style="text-align: center;"> Formulario de ventas de seguro para Vehiculos </h1> 
    </div>
    <br>
    <br>
    ...
    <div class="container-fluid">
            ...
            <form class="row g-3" action="DatosVehiculos.php" method="post" name="frm">
            <h3> Datos del vehiculo </h3> 

        <div class="col-md-12">
            <label for="inputState" class="form-label">Clase de Vehiculo</label>
            <select name="vehiculo" class="form-select" required>
                <option selected> Selecciona la clase de vehiculo</option>
        ...
        <div class="col-md-6">
            <label for="id" class="form-label"> N° de Poliza </label>
            <input type="id" class="form-control"  name="poliza" required>
        </div>
        ...
        <div class="col-6">
            ...
            <input type="number" class="form-control" name="año"  min ="2000" max="2022"required>
        </div>

        <div class="col-md-12">
            <label for="inputState" class="form-label">Uso</label>
            <select name="uso" class="form-select" required>
                <option selected> Selecciona el uso del vehiculo</option>
                <option>Particular</option>
                <option>Trabajo</option>
                <option>Trabajo y Particular</option>
            </select>
        </div>
